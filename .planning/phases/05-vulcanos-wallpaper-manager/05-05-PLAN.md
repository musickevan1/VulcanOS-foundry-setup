...
Output: Profile manager UI with save/load/delete functionality and persistent TOML storage.
</objective>
...
2. Profile directory created at `~/.config/vulcan-wallpaper/profiles/`
3. Profiles save as valid TOML files
4. Profile manager component renders with dropdown and buttons
5. Known profiles (desktop, laptop, campus) recognized
</verification>
