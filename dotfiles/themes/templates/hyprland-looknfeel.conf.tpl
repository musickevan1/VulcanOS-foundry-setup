...
general {
    ...
    col.active_border = rgba(${GRADIENT_START_RAW}ff) rgba(${GRADIENT_END_RAW}ff) 45deg
    col.inactive_border = rgba(${BORDER_INACTIVE_RAW}aa)
...
decoration {
    ...
    shadow {
        ...
        render_power = 3
        ignore_window = true
        color = rgba(${BG_SURFACE_RAW}ee)
        color_inactive = rgba(${BG_SURFACE_RAW}99)
        offset = 2 2
        scale = 1.0
    }
...
group {
    ...
    col.border_active = rgba(${ACCENT_RAW}ff)
    col.border_inactive = rgba(${BORDER_INACTIVE_RAW}aa)
    col.border_locked_active = rgba(${RED_RAW}ff)
    col.border_locked_inactive = rgba(${BORDER_INACTIVE_RAW}aa)
    ...
    groupbar {
        ...
        render_titles = true
        scrolling = true
        text_color = rgba(${FG_PRIMARY_RAW}ff)
        col.active = rgba(${ACCENT_RAW}ff)
        col.inactive = rgba(${BORDER_INACTIVE_RAW}aa)
        col.locked_active = rgba(${RED_RAW}ff)
        col.locked_inactive = rgba(${BORDER_INACTIVE_RAW}aa)
    }
}
